...
}`,g=(a,b)=>{let c=d.createShader(a);return d.shaderSource(c,b),d.compileShader(c),c},h=d.createProgram();d.attachShader(h,g(d.VERTEX_SHADER,e)),d.attachShader(h,g(d.FRAGMENT_SHADER,f)),d.linkProgram(h),d.useProgram(h);let i=d.createBuffer();d.bindBuffer(d.ARRAY_BUFFER,i),d.bufferData(d.ARRAY_BUFFER,new Float32Array([-1,-1,1,-1,-1,1,1,1]),d.STATIC_DRAW);let j=d.getAttribLocation(h,"a_position");d.enableVertexAttribArray(j),d.vertexAttribPointer(j,2,d.FLOAT,!1,0,0);let k=d.getUniformLocation(h,"u_time"),l=d.getUniformLocation(h,"u_resolution"),m=d.getUniformLocation(h,"u_mouse"),n={x:b.width/2,y:b.height/2};window.addEventListener("mousemove",a=>{let c=b.getBoundingClientRect();if(c.width&&c.height){let d=(a.clientX-c.left)/c.width,e=1-(a.clientY-c.top)/c.height;n.x=d*b.width,n.y=e*b.height}});let o=a=>{"u"<typeof ResizeObserver&&c(),d.viewport(0,0,b.width,b.height),k&&d.uniform1f(k,.001*a),l&&d.uniform2f(l,b.width,b.height),m&&d.uniform2f(m,n.x,n.y),d.drawArrays(d.TRIANGLE_STRIP,0,4),requestAnimationFrame(o)};o(0)},[]),(0,b.jsx)("div",{className:"fixed inset-0 w-full h-full z-0 pointer-events-none opacity-40",children:(0,b.jsx)("canvas",{ref:a,style:{display:"block",width:"100%",height:"100%"}})})}])},81047,a=>{"use strict";var b=a.i(75806),c=a.i(60094);a.s(["default",0,function({src:a,poster:d,ariaLabel:e,className:f}){let g=(0,c.useRef)(null),[h,i]=(0,c.useState)(null);return(0,c.useEffect)(()=>{let b=g.current;if(!b)return;let c=()=>{let c=b.error,d="Unknown video error";c&&(d=`MediaError code=${c.code}`,c.message&&(d+=` message=${c.message}`)),console.error("VideoPlayer error",d,{src:a}),i(d)},d=()=>i(null);return b.addEventListener("error",c),b.addEventListener("play",d),()=>{b.removeEventListener("error",c),b.removeEventListener("play",d)}},[a]),(0,b.jsxs)("div",{className:f??"",children:[(0,b.jsx)("video",{ref:g,controls:!0,poster:d,className:"w-full h-full min-h-[280px] object-cover","aria-label":e,preload:"metadata",playsInline:!0,children:(0,b.jsx)("source",{src:a,type:"video/mp4"})}),h&&(0,b.jsxs)("div",{className:"mt-3 rounded-md bg-red-900/80 p-3 text-sm text-white",children:[(0,b.jsxs)("div",{children:["Video failed to play: ",h]}),(0,b.jsxs)("div",{className:"mt-2 flex gap-2",children:[(0,b.jsx)("a",{href:a,target:"_blank",rel:"noreferrer",className:"underline",children:"Open raw video"}),(0,b.jsx)("a",{href:a,download:!0,className:"underline",children:"Download"})]})]})]})}])}];

//# sourceMappingURL=Downloads_mm_printing_components_049l45p._.js.map